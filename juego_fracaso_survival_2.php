...
<body class="bg-gray-100 text-gray-800">
    ...
    <main class="max-w-4xl mx-auto p-4">
        <section class="bg-gradient-to-r to-yellow-500 from-red-600 p-6 rounded-lg shadow-lg mb-6">
            <img src="./images/juego_fracaso_survival_2.jpg" alt="Imagen del Juego" class="w-full h-64 object-cover rounded-lg mb-4">
            <h2 class="text-2xl font-bold mb-2">No Man's Sky (en su lanzamiento inicial)</h2>
            <p class="text-gray-600 mb-4">Empresa Desarrolladora: <span class="font-semibold">Hello Games</span></p>
            <p class="text-gray-800 mb-4">Descripción: Prometió mucho pero no cumplió con las expectativas, aunque ha mejorado con el tiempo a través de actualizaciones.</p>
