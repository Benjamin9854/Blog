...
<body class="bg-gray-100">
    <h2 class="text-center text-2xl font-extrabold text-gray-900 dark:text-white md:text-4xl lg:text-5xl mb-8 mt-5">
        <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Mayores fracasos</span>
    </h2>
    ...
    <script>
        const genres = {
            'Acción': ['Anthem', 'Mighty No. 9', 'Duke Nukem Forever'],
            'Terror': ['Alone in the Dark: Illumination', 'Silent Hill: Downpour', 'Daylight'],
            'Supervivencia': ['Metal Gear Survive', 'No Man\'s Sky (en su lanzamiento inicial)', 'We Happy Few'],
            'Mundo Abierto': ['Fallout 76', 'Mass Effect: Andromeda', 'Cyberpunk 2077 (en su lanzamiento inicial)']
        };
