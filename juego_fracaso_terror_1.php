...
<body class="bg-gray-100 text-gray-800">
    ...
    <main class="max-w-4xl mx-auto p-4">
        <section class="bg-gradient-to-r to-yellow-500 from-red-600 p-6 rounded-lg shadow-lg mb-6">
            <img src="./images/juego_fracaso_terror_1.jpg" alt="Imagen del Juego" class="w-full h-64 object-cover rounded-lg mb-4">
            <h2 class="text-2xl font-bold mb-2">Alone in the Dark: Illumination</h2>
            <p class="text-gray-600 mb-4">Empresa Desarrolladora: <span class="font-semibold">Pure FPS</span></p>
            <p class="text-gray-800 mb-4">Descripción: Mal recibido por su jugabilidad deficiente y falta de terror, no logrando capturar la esencia de sus predecesores.</p>
