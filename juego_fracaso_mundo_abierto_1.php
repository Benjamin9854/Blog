...
<body class="bg-gray-100 text-gray-800">
    ...
    <main class="max-w-4xl mx-auto p-4">
        <section class="bg-gradient-to-r to-yellow-500 from-red-600 p-6 rounded-lg shadow-lg mb-6">
            <img src="./images/juego_fracaso_mundo_abierto_1.jpg" alt="Imagen del Juego" class="w-full h-64 object-cover rounded-lg mb-4">
            <h2 class="text-2xl font-bold mb-2">Fallout 76</h2>
            <p class="text-gray-600 mb-4">Empresa Desarrolladora: <span class="font-semibold">Bethesda Game Studios</span></p>
            <p class="text-gray-800 mb-4">Descripción: Criticado por su cantidad de bugs y falta de contenido significativo, decepcionando a muchos fans de la serie Fallout.</p>
