...
<head>
    ...
    <title>CGM - Blog de Críticas de Videojuegos</title>
...
<body>
    <div class="container">
        <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl mb-4">
            <span class="text-transparent bg-clip-text bg-gradient-to-r to-yellow-400 from-sky-400">Bienvenido a CGM Critics</span>
        </h1>
